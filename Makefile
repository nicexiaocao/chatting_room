#############################################################################
# Makefile for building: Chatting_room
# Generated by qmake (3.1) (Qt 5.14.2)
# Project:  Chatting_room.pro
# Template: subdirs
# Command: D:\Qt\Qt5.14.2\5.14.2\mingw73_32\bin\qmake.exe -o Makefile Chatting_room.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
sub-Client-qmake_all:  FORCE
	...
	cd Client\ && $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
	cd Client\ && $(MAKE) -f Makefile qmake_all
sub-Client: FORCE
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile
sub-Client-make_first: FORCE
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile 
sub-Client-all: FORCE
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile all
sub-Client-clean: FORCE
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile clean
sub-Client-distclean: FORCE
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile distclean
sub-Client-install_subtargets: FORCE
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile install
sub-Client-uninstall_subtargets: FORCE
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile uninstall
sub-Service-qmake_all:  FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
	cd Service\ && $(MAKE) -f Makefile qmake_all
sub-Service: FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile
sub-Service-make_first: FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile 
sub-Service-all: FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile all
sub-Service-clean: FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile clean
sub-Service-distclean: FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile distclean
sub-Service-install_subtargets: FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile install
sub-Service-uninstall_subtargets: FORCE
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile uninstall

Makefile: Chatting_room.pro D:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/win32-g++/qmake.conf D:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/features/spec_pre.prf \
		...
		Chatting_room.pro
	$(QMAKE) -o Makefile Chatting_room.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
...
qmake_all: sub-Client-qmake_all sub-Service-qmake_all FORCE

make_first: sub-Client-make_first sub-Service-make_first  FORCE
all: sub-Client-all sub-Service-all  FORCE
clean: sub-Client-clean sub-Service-clean  FORCE
distclean: sub-Client-distclean sub-Service-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-Client-install_subtargets sub-Service-install_subtargets FORCE
uninstall_subtargets: sub-Client-uninstall_subtargets sub-Service-uninstall_subtargets FORCE

sub-Client-debug:
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile debug
sub-Service-debug:
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile debug
debug: sub-Client-debug sub-Service-debug

sub-Client-release:
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile release
sub-Service-release:
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile release
release: sub-Client-release sub-Service-release

sub-Client-check:
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile check
sub-Service-check:
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile check
check: sub-Client-check sub-Service-check

sub-Client-benchmark:
	@if not exist Client\ mkdir Client\ & if not exist Client\ exit 1
	cd Client\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Client\Client.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile benchmark
sub-Service-benchmark:
	@if not exist Service\ mkdir Service\ & if not exist Service\ exit 1
	cd Service\ && ( if not exist Makefile $(QMAKE) -o Makefile E:\xiaocao\Documents\Qt\Chatting_room\Service\Service.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile benchmark
benchmark: sub-Client-benchmark sub-Service-benchmark
